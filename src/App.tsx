...
const SellerProfile = lazyRoute(() => import("./pages/SellerProfile"));
const Categories = lazyRoute(() => import("./pages/Categories"));
const CategoryPage = lazyRoute(() => import("./pages/CategoryPage"));
const SuppliersByCityCategory = lazyRoute(() => import("./pages/SuppliersByCityCategory"));
const LocalLandingPage = lazyRoute(() => import("./pages/LocalLandingPage"));
const LocalLandingPages = lazyRoute(() => import("./pages/admin/LocalLandingPages"));
const PostRequirement = lazyRoute(() => import("./pages/PostRequirement"));
const MatchedLeads = lazyRoute(() => import("./pages/seller/MatchedLeads"));
const SellerDashboard = lazyRoute(() => import("./pages/seller/Dashboard"));
const SellerOnboarding = lazyRoute(() => import("./pages/seller/Onboarding"));
const MyProducts = lazyRoute(() => import("./pages/seller/MyProducts"));
const LeadInbox = lazyRoute(() => import("./pages/seller/LeadInbox"));
const SellerAnalytics = lazyRoute(() => import("./pages/seller/Analytics"));
const Subscription = lazyRoute(() => import("./pages/seller/Subscription"));
const EditProfile = lazyRoute(() => import("./pages/seller/EditProfile"));
const SellerAvailability = lazyRoute(() => import("./pages/seller/Availability"));
const DealPipeline = lazyRoute(() => import("./pages/seller/DealPipeline"));
const SellerServices = lazyRoute(() => import("./pages/seller/Services"));
...
const ManageLeads = lazyRoute(() => import("./pages/admin/ManageLeads"));
const ManageRequirements = lazyRoute(() => import("./pages/admin/ManageRequirements"));
const PlatformSettings = lazyRoute(() => import("./pages/admin/PlatformSettings"));
const AdminAnalytics = lazyRoute(() => import("./pages/admin/Analytics"));
const LeadPricing = lazyRoute(() => import("./pages/admin/LeadPricing"));
const AutoLeads = lazyRoute(() => import("./pages/admin/AutoLeads"));
const BusinessLeads = lazyRoute(() => import("./pages/admin/BusinessLeads"));
const TodayAnalysis = lazyRoute(() => import("./pages/admin/TodayAnalysis"));
const SeoConsole = lazyRoute(() => import("./pages/admin/SeoConsole"));
const SeoGuide = lazyRoute(() => import("./pages/admin/SeoGuide"));
const ManageAds = lazyRoute(() => import("./pages/admin/ManageAds"));
const DailyOps = lazyRoute(() => import("./pages/admin/DailyOps"));
...
const RefundPolicy = lazyRoute(() => import("./pages/RefundPolicy"));
const FindBusinesses = lazyRoute(() => import("./pages/FindBusinesses"));
const Cities = lazyRoute(() => import("./pages/Cities"));
const DirectoryPage = lazyRoute(() => import("./pages/directory/DirectoryPage"));
const BrandPage = lazyRoute(() => import("./pages/directory/BrandPage"));
const CityHubPage = lazyRoute(() => import("./pages/directory/CityHubPage"));
const BuyingGuide = lazyRoute(() => import("./pages/directory/BuyingGuide"));
const Guides = lazyRoute(() => import("./pages/directory/Guides"));
const TradeShows = lazyRoute(() => import("./pages/TradeShows"));
const TradeLeads = lazyRoute(() => import("./pages/TradeLeads"));
const Distributors = lazyRoute(() => import("./pages/Distributors"));
const Pricing = lazyRoute(() => import("./pages/Pricing"));
const BusinessNeeds = lazyRoute(() => import("./pages/BusinessNeeds"));
