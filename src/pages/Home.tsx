...
export default function Home() {
  ...
  <Helmet>
    ...
    <MarketplaceLayout showSearch={false}>
      ...
      <section className="hidden md:block py-12 bg-card border-b">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-3 gap-8">
            {[
              { label: "Verified Sellers", value: stats.sellers, icon: Building2, color: "text-primary" },
              { label: "Products Listed", value: stats.products, icon: Package, color: "text-accent" },
              { label: "Categories", value: stats.categories, icon: Factory, color: "text-info" },
            ].map((stat, i) => (
              <div key={i} className="text-center">
                ...
                {statsLoaded ? (
                  ...
                  <div className="h-9 md:h-10 w-24 mx-auto mb-1 rounded-md bg-muted animate-pulse" />
                )}
